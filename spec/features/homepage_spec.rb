...
feature 'Homepage' do
  ...
  describe 'includes list of the newest publications' do
    ...
    it 'which is ordered from the newest to the oldest publications' do
      page.should have_selector('#publications > li:nth-child(1)', text: first_publication.content)
      page.should have_selector('#publications > li:nth-child(2)', text: second_publication.content)
    end
  end
end
